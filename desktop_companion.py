...
class DesktopCompanion:
    def __init__(self) -> None:
        ...
        self.canvas = tk.Canvas(self.root, width=310, height=230, bg="#ff00ff", highlightthickness=0)
        self.canvas.pack()
        self.root.geometry("+1040+580")
    ...
    def draw(self) -> None:
        ...
        self.canvas.create_oval(x + 52, y - 8, x + 72, y + 12, fill="#00C805", outline="#D7FFE0", width=3)
        ...
        self.canvas.create_oval(x + 49, y + 75, x + 75, y + 101, fill="#00C805", outline="")
        ...
        self.canvas.create_oval(x + 45, y + 44, x + 56, y + 55, fill="#00C805", outline="")
        self.canvas.create_oval(x + 68, y + 44, x + 79, y + 55, fill="#00C805", outline="")
    ...
    def draw_bubble(self, accent: str, tagline: str) -> None:
        self.round_rect(146, 28, 300, 145, 18, fill="#0B1117", outline=accent, width=3)
        self.canvas.create_polygon(146, 93, 125, 104, 146, 113, fill="#0B1117", outline=accent)
        self.canvas.create_text(160, 48, text=f"{self.name}: {tagline}", anchor="w", fill=accent, font=("Segoe UI", 9, "bold"))
        self.canvas.create_text(
            160,
            83,
            text=TIPS[self.tip_index],
            anchor="w",
            fill="#F3F7FA",
            font=("Segoe UI", 10),
            width=126,
        )
        self.canvas.create_text(160, 130, text="Drag me. Right-click cycles. Space = tip. Esc = close.", anchor="w", fill="#A8B3C2", font=("Segoe UI", 7))
